...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    user_type = models.ForeignKey(UserLayer, on_delete=models.CASCADE, related_name='user_Layer', null=True)
    agency = models.ForeignKey(Agency, on_delete=models.CASCADE, related_name='user_agency', null=True)
    team = models.ForeignKey(Team, on_delete=models.CASCADE, related_name='user_teams', null=True)
