...
class Agency(BaseModel):
    ...
    travelport_itx = models.BooleanField(default=False) # not needed
...
class DataSource(BaseModel):
    ...
    PROVIDER_CHOICES = [('1A', '1A'), ('1V', '1V'), ('1G', '1G'), ('1P', '1P')] # break out tuples
    ...
    agency = models.ForeignKey(Agency, on_delete=models.CASCADE, related_name='datasource_agency', null=True) # remove deletion cascading
...
class Team(BaseModel):
    ...
    agency = models.ForeignKey(Agency, on_delete=models.CASCADE, related_name='teams_agency', null=True) # remove deletion cascading
    common_parameters = models.OneToOneField(CommonParameters, on_delete=models.CASCADE,
                                             related_name='teams_common_parameters', null=True)
    admin = models.ForeignKey('users.User', on_delete=models.CASCADE, related_name='team_user', null=True) # remove deletion cascading
